      ...
      <div className="hidden lg:flex lg:flex-1 lg:flex-col lg:justify-center lg:px-12">
        <div className="max-w-md">
          ...
          <p className="text-lg text-gray-600 mb-8">
            Securely manage your medical records, get AI-powered health
            insights, and never miss important medications or appointments.
          </p>
          ...
          <div className="mt-8 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Disclaimer:</strong> HealthMitra provides health
              information and AI suggestions for educational purposes only.
