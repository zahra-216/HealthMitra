// client/src/pages/AIInsights/AIInsights.tsx
...
const AIInsights: React.FC = () => {
  ...
  const getInsightIcon = (type: InsightType["type"]) => {
    const icons: Record<InsightType["type"], typeof Brain> = {
          ...
          {insights.map((insight: InsightType) => {
            ...
            return (
              <Card
                key={insight._id}
                className={`${
                  !insight.isRead ? "ring-2 ring-primary-500" : ""
                }`}
              >
                <CardHeader>
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-3">
                      <div
                        className={`p-2 rounded-full flex-shrink-0 risk-${insight.severity}`}
                      >
