...
const Dashboard = () => {
  ...
  useEffect(() => {
    dispatch(fetchHealthRecords({ page: 1, limit: 5 }));
            ...
            {insights.length > 0 ? (
              <div className="space-y-4">
                {insights.slice(0, 3).map((insight) => (
                  ...
                  >
                    <div className={`p-1 rounded-full flex-shrink-0 risk-${insight.severity}`}>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-800">
                  <strong>Stay Hydrated:</strong> Drink at least 8 glasses of water daily to maintain optimal health and support your body's vital functions.
                </p>
              </div>
            </div>
          </div>
